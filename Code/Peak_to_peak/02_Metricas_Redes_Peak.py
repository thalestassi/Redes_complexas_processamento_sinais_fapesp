...
mutual_information_a = mutual_information(flatten_matrices(matrizes_a_pearson), flatten_matrices(matrizes_a_peak))
mutual_information_c = mutual_information(flatten_matrices(matrizes_c_pearson), flatten_matrices(matrizes_c_peak))
...
np.save("Metricas/Metricas_autistas_pearson_peak.npy", resultados_metricas_a_pearson)
np.save("Metricas/Metricas_controle_pearson_peak.npy", resultados_metricas_c_pearson)
